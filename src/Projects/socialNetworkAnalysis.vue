<template>
  <div>
	<article id="post-391" class="post-391 project type-project status-publish has-post-thumbnail hentry project_tag-igraph project_tag-sna project_tag-yelp et_pb_post">
		...
		<div class="et-l et-l--post">
			<div class="et_builder_inner_content et_pb_gutters3"><div class="et_pb_section et_pb_section_0 et_section_regular" >
				...
				<div class="et_pb_text_inner"><h1>Social Network Analysis</h1>
...
<p>Let&#8217;s see who are the &#8220;friendly users&#8221; that gave the highest number of reviews to those 36 restaurants:<img class="aligncenter wp-image-566 size-full" src="../assets/Top-Users-by-Number-of-Reviewes.png" alt="top-users-by-number-of-reviewes" width="712" height="577" srcset="../assets/Top-Users-by-Number-of-Reviewes.png 712w, ../assets/Top-Users-by-Number-of-Reviewes-300x243.png 300w" sizes="(max-width: 712px) 100vw, 712px" /></p>
...
<p><div id="attachment_583" style="width: 919px" class="wp-caption aligncenter"><img aria-describedby="caption-attachment-583" class="wp-image-583 size-full" src="../assets/Top-Users-by-Centrality-Rank.png" alt="Top Users By Betweenes Centrality" width="909" height="567" srcset="../assets/Top-Users-by-Centrality-Rank.png 909w, ../assets/Top-Users-by-Centrality-Rank-300x187.png 300w, ../assets/Top-Users-by-Centrality-Rank-768x479.png 768w, ../assets/Top-Users-by-Centrality-Rank-400x250.png 400w" sizes="(max-width: 909px) 100vw, 909px" /><p id="caption-attachment-583" class="wp-caption-text">Top Users By Betweeness Centrality</p></div></p>
