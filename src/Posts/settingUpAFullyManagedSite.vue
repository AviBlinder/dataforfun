            ...
            <article>
              <div class="section">
                <div class="container">
                  ...
                  <div class="block my-4">
                    ...
                    <div class="block">
                      <p>
                        ...
                        servers elastically, as demand grows up or down,
                        handling failure policies, in case of a whole set of
                        servers going down, and more.
                      </p>
                    </div>
                    <div class="block">
                      <p>
                    ...
                    <div class="card-content is-flex is-horizontal-center">
                      <figure class="image is-400x400">
                        <img
                          ...
                          alt="VPC Setup"
                        />
                        <figcaption class="is-centered ml-6">
                          VPC Setup
                        </figcaption>
                      </figure>
                    </div>
                  ...
                  <div class="block">
                    <p>
                      5. Two of the greatest features of a cloud service (and of
                      course AWS) are their built-in mechanisms of
                      <strong>auto-scaling</strong> as traffic (or other needs)
                      grows up and down and the enhanced
                  ...
                  <div class="block">
                    <p>
                      The
                      <strong>Elastic Load Balancer (ELB) </strong>service is a
                      tool that in fact has two purposes: constantly checking
                      the health state of associated instances (and hence
                      routing traffic only to healthy ones) and balancing
                      traffic evenly across associated instances. In order to
                      manage my costs in an effective way, I associated one
                      'fixed' <strong>Reserved Instance</strong> to the ELB
                      (since it serves a 24/7 site, I decided pre-paying for it
                      for a whole year and thus 'reserving' the resource)
                    </p>
                  </div>
                  <div class="block">
                    <p>
                      <strong>AutoScaling: </strong> a second, optional
                      <strong>Spot Instance</strong>, which will be launched in
                      case of increased traffic and associated to the
                      <strong>ELB</strong>, is triggered thru the Auto-scaling
                      mechanism. Also in this case, in order to manage costs, I
                      decided to 'bid' for a maximum price for this additional
                      resource, under the assumption that higher traffics on a
                      specific site are not related to spikes of demands in the
                      whole availability zone. The auto-scaling service will
                      shut down the additional instance once traffic goes down
                      and can be served by a single instance. In the future, if
                      traffic is higher for longer periods of time, the
                  ...
                  <div class="block">
                    <p>
                      Since I'm hosting my domain also under AWS, the next taken
                      step is configuring creating a
                      <strong>hosted zone</strong> under
                      <strong>Route53</strong> service so different variations
                      of the site name and subdomains are routed to the correct
                      instances.
                    </p>
                  </div>
                  <div class="block">
                    <p>
                      ...
                      routing traffic to any number of associated instances, an
                      'A' record is created mapping between the domain name and
                  ...
                  <div class="block">
                    <p>
                      ...
                      lets you route traffic to a completely different region or
                      to a static site (hosted under S3), in case of total
                  ...
                  <div>
                    ...
                    <ol>
                      <li class="block ml-3">
                        ...
                        replicate every few minutes the updated contents of the
                        site to an
                        <strong>S3 bucket containing the media files</strong>.
                        (In fact two buckets: one holding media files and one
                        holding the whole site's code. This second bucket is the
                        base of any new launched instance).
                      </li>
                      <li class="block ml-3">
