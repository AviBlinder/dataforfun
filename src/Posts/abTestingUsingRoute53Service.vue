...
<div class="block">
                        ...
                        <p>
                          ...
                          you'll meet the following screen
                        </p>
                      </div>
                    </div>
                    ...
                    <div>
                      <div>
                        ...
                        <p>
                          <img
                            class="alignleft size-full wp-image-968"
                    ...
                    <div>
                      <div class="block">
                        <p>
                          ...
                          to which each route will be connected:
                        </p>
                        <p>
                          <img
                            class="alignleft size-full wp-image-964"
                        ...
                        <p class="block">
                          ...
                          free and
                          <strong
                            >currently costs $50 per policy record per
                            month</strong
                          >
                    ...
                    <div>
                      <div>
                        ...
                        <p>
                          ...
                          routed to each instance (how many users visited each
                          instance) and even analyze user behaviors on each
                          instance. For this purpose, you can combine analysis
                          tools setup on each instance, such as
